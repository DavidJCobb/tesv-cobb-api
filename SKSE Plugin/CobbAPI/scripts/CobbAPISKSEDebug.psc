Scriptname CobbAPISKSEDebug Hidden
{Used when debugging the DLL. DO NOT INCLUDE IN RELEASE BUILDS.}

Function EchoMemoryLocationOf(Form akSubject) Global Native
Function EchoMemoryLocationOfAlias(Alias akSubject) Global Native

Function RunTestOnForm     (Form akSubject) Global Native
Function RunTestOnReference(ObjectReference akSubject) Global Native

Function AttemptToMoveTeleportMarker(ObjectReference akSubject, Float[] afCoordinates) Global Native

Function DumpWeakReferenceInfo() Global Native

Int Function AddNavcutByBounds(ObjectReference akSubject, Form akUseBoundsOf) Global Native

Float[] Function ArraySliceFloat(Float[] afArray, Int aiStart, Int aiCount) Global Native
ObjectReference[] Function ArrayWriteReference(ObjectReference[] akTarget, ObjectReference[] akSource, Int aiStartWritingAt) Global Native
Function ArrayWriteReferenceNOCOPY(ObjectReference[] akTarget, ObjectReference[] akSource, Int aiStartWritingAt) Global Native
